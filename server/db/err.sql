...
-- 2018년 05월 25일 (금) 오후 11시 08분 43초
...
CREATE TABLE IF NOT EXISTS `wordbook` (
  ...
  `user_id` INT NOT NULL,
  `wordbook_is_unknown` TINYINT NOT NULL,
...
-- -----------------------------------------------------
-- Placeholder table for view `user_with_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `user_with_detail` (`user_id` INT, `user_name` INT, `user_profile_image` INT, `user_added_date` INT);

-- -----------------------------------------------------
-- Placeholder table for view `oauth_passport_by_service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `oauth_passport_by_service` (`oauth_service_name` INT, `oauth_user_id` INT, `user_id` INT);

-- -----------------------------------------------------
-- View `user_with_detail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `user_with_detail`;
...
-- -----------------------------------------------------
-- View `oauth_passport_by_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `oauth_passport_by_service`;
