...
CREATE TABLE IF NOT EXISTS `gorani_reader`.`definition` (
  `word_id` INT NOT NULL,
  `definition_sequence` INT NOT NULL,
  `definition` VARCHAR(100) NULL,
  PRIMARY KEY (`word_id`, `definition_sequence`),
...
CREATE TABLE IF NOT EXISTS `gorani_reader`.`wordbook` (
  ...
  `wordbook_added_date` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gorani_reader`.`wordbook_entry` (
  ...
  `wordbook_entry_correct_number` INT NOT NULL,
  `wordbook_entry_added_date` DATETIME NOT NULL,
  PRIMARY KEY (`wordbook_id`, `word_id`, `definition_sequence`),
  INDEX `fk_wordbook_entry2_idx` (`word_id` ASC, `definition_sequence` ASC),
  CONSTRAINT `fk_wordbook_entry`
    FOREIGN KEY (`wordbook_id`)
    REFERENCES `gorani_reader`.`wordbook` (`wordbook_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_wordbook_entry2`
    FOREIGN KEY (`word_id` , `definition_sequence`)
    REFERENCES `gorani_reader`.`definition` (`word_id` , `definition_sequence`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gorani_reader`.`wordbook_quiz_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gorani_reader`.`wordbook_quiz_history` (
  `wordbook_id` INT NOT NULL,
  `wordbook_quiz_history_time` INT NOT NULL,
  `wordbook_quiz_type_code` INT NOT NULL,
  `wordbook_quiz_history_accuracy` DOUBLE NOT NULL,
  `wordbook_quiz_history_ended_date` DATETIME NOT NULL,
  PRIMARY KEY (`wordbook_id`, `wordbook_quiz_history_time`, `wordbook_quiz_type_code`),
  INDEX `fk_wordbook_quiz_history2_idx` (`wordbook_quiz_type_code` ASC),
  CONSTRAINT `fk_wordbook_quiz_history`
    FOREIGN KEY (`wordbook_id`)
    REFERENCES `gorani_reader`.`wordbook` (`wordbook_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_wordbook_quiz_history2`
